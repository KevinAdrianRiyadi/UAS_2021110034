                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('editdessert', $item->id) }}" class="btn btn-primary me-2">Edit</a>
                                <form action="{{ route('deletedessert', $item->id) }}" method="POST"
